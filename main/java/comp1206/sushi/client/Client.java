...
//		updater.sendOrder(new Order());
//		order.setOrder(user.getBasket());
...
//		notifyUpdate();
	...
	public void cancelOrder(Order order) {
		// TODO Auto-generated method stub
		Order correctRefference = gh.ifInList(this.currentUser.getOrderHistory(), order.getName());
		correctRefference.setStatus("Cancelled");

		updater.sendOrder(correctRefference);
//		notifyUpdate();
	}
